            ...
            <div className="container">
              <div className="bio-content" id="anggota1" data-tab-content class="active">
                ...
                <div className="bio-main">
                  <div className="main-content">
                    <h1>Arlando Muhammad Farrel</h1>
                    <p>Farrel menyukai hal yang berbau video game
            ...
            <div className="container">
              <div className="bio-content" id="anggota1" data-tab-content class="active">
                ...
                <div className="bio-main">
                  <div className="main-content">
                    <h1>Fadhila Zalfa Alisya</h1>
                    <p>Zalfa menyukai hal yang berbau seni
            ...
            <div className="container">
              <div className="bio-content" id="anggota1" data-tab-content class="active">
                ...
                <div className="bio-main">
                  <div className="main-content">
                    <h1>Griselda Putri Cahyaningtyas</h1>
                    <p>Grisel menyukai kegiatan menulis
            ...
            <div className="container">
              <div className="bio-content" id="anggota1" data-tab-content class="active">
                ...
                <div className="bio-main">
                  <div className="main-content">
                    <h1>Khusnul Faddila</h1>
                    <p>Dila menyukai hal yang berbau multimedia
                ...
                <div className="bio-add">
                  <h3>My Favorite Place</h3>
                  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3952.3825149062955!2d112.49451371401337!3d-7.854975280247541!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e7887fbc3e96b31%3A0x959ffe132aa1bd4e!2sParalayang!5e0!3m2!1sid!2sid!4v1667264694441!5m2!1sid!2sid"
                    width={300}
                    height={200}
                    style={{ "border": "0" }}
                    title="iframe Dila"
